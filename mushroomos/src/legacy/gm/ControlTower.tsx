...
import { nowDate, nowMs } from '../../shared/utils/now';

import { PageHeading } from '../../shared/ui/layout/PageHeading';
import { EmptyState, Skeleton, Stat } from '../../shared/ui/primitives';
import { ExceptionBand } from '../ui/ExceptionBand';
import { StaircaseCalendar } from '../ui/StaircaseCalendar';
...
export function ControlTower() {
  ...
  const bunkers = vessels.filter((v: { kind: string }) => v.kind === 'BUNKER');
  const tunnels = vessels.filter((v: { kind: string }) => v.kind === 'TUNNEL');
