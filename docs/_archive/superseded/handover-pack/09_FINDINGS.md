...
| **F14** | **The repository teaches the wrong process.** 15 root markdown files, 10,193 lines; **15 of 15 mention 552, none mentions 470.** Seven are pasted conversation filed where specifications live. | Phase 0 · `02_DOCUMENT_MAP.md` |
