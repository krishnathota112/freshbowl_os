...
Derived from `docs/architecture/SYSTEM_ARCHITECTURE_V1.md`. Every task is self-contained: an agent
...
**Allowed files** `src/api/*` · a new `docs/architecture/DATA_CONTRACTS.md`
...
`docs/handover/09_FINDINGS.md` F7.
...
Reconciliation and reasoning: `docs/architecture/PRD_470H_RECONCILIATION.md`.
...
`README.md` · `docs/architecture/SYSTEM_ARCHITECTURE_V1.md` (§14/§15 prose only)
