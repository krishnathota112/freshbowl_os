# Claude Code — foundation mission

**This document is addressed to Claude Code only.** Paste the block below into Claude Code in
`T:\freshbowl_os`. It supersedes the Phase 1 prompt.

Other agents on this project have their own documents and must not be given this one.
